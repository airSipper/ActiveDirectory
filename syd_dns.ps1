...
Add-DnsServerResourceRecord -ZoneName  -A -Name "ns1.piedpiper.com" -IPv4Address "XXX.XXX.XXX.XXX"

# Add a PTR record for the name server in the RLZ
Add-DnsServerResourceRecord -Name "ns1" -Ptr -ZoneName "0.16.172.in-addr.arpa" -AllowUpdateAny -PtrDomainName "ns1.piedpiper.com"
